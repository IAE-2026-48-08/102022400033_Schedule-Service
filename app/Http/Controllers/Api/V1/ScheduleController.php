    ...
    #[OA\Get(
        ...
        responses: [
            new OA\Response(
                ...
                content: new OA\JsonContent() // <--- Ini yang mengubah accept: */* menjadi application/json
            ),
    ...
    #[OA\Get(
        ...
        responses: [
            new OA\Response(
                ...
                content: new OA\JsonContent() // <--- Tambahan JsonContent
            ),
    ...
    #[OA\Post(
        ...
        requestBody: new OA\RequestBody(
            ...
            content: new OA\JsonContent(
                required: ["vehicle_id", "driver_id", "destination", "departure_date", "return_date", "purpose"],
                properties: [
